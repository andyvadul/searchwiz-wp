 ...
 */
class SearchWiz_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'is-radio-image', SEARCHWIZ_PLUGIN_URI . 'includes/customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), SEARCHWIZ_VERSION, true );
		wp_enqueue_style( 'is-radio-image', SEARCHWIZ_PLUGIN_URI . 'includes/customizer/controls/radio-image/radio-image.css', null, SEARCHWIZ_VERSION );
	}
