...
class SearchWiz_Base_Options {
     ...
     * @return SW_Option The retrieved object of this class or inherited class.
     */
    public static function load( $force = false ) {
        ...
        return apply_filters( 'searchwiz_model_option_load', $model, $class );
    }
    ...
    public function get_is_option( $option, $default = '' ) {
        if ( empty( static::$opt ) ) {
            static::$opt = get_option( 'searchwiz_settings', array() );
        }
        $value = $default;
