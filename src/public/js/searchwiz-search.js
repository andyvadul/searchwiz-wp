( function( $ ) {
	...
	$( window ).on( 'load', function() {
		...
		if ( typeof SearchWizVars !== "undefined" &&  typeof SearchWizVars.is_analytics_enabled !== "undefined" ) {
			if ( typeof SearchWizVars.is_search !== "undefined" && typeof SearchWizVars.is_search ) {
				var id = ( typeof SearchWizVars.is_id !== "undefined" ) ? SearchWizVars.is_id : 'Default';
				var label = ( typeof SearchWizVars.is_label !== "undefined" ) ? SearchWizVars.is_label : '';
				var category = ( typeof SearchWizVars.is_cat !== "undefined" ) ? SearchWizVars.is_cat : '';
				searchwiz_search_analytics( id, label, category );
			}
		}
	...
	$( window ).click( function( e ) {
		if ( 0 === e.button && 0 === $( e.target ).closest( '.searchwiz-search-input' ).length && 0 === $( e.target ).closest( '.is-search-submit' ).length && 0 === $( e.target ).closest( '.is-ajax-search-result' ).length && 0 === $( e.target ).closest( '.is-ajax-search-details' ).length ) {
...
function searchwiz_search_analytics( id, label, category ) {
    try {
